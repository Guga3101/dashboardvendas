...
@avaliacao in `Avaliação da compra` and \
...
with coluna1:
    ...
    nome_arquivo += '.csv'
with coluna2:
    st.download_button('Fazer o downlaod da tabela em csv', data = convert_csv(dados_filtrados), file_name = nome_arquivo, mime = 'text/csv', on_click = mensagem_sucesso)
